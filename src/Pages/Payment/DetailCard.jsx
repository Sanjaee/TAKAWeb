    ...
    <div className="detail_populer_container">
      ...
      <div className="detail_populer_header">
        {Object.keys(populer).length > 0 && (
          <div>
            <img src={populer.imagebg} alt="" loading="lazy" />
          ...
          <div className="container grid grid-cols-3 gap-8 pb-8 pt-8 ">
            <div className="col-span-3 md:col-span-1 hidden md:block ">
              <div className="sticky top-24 flex flex-col space-y-8">
                <div class="rounded-xl bg-[#27242d] text-white shadow-2xl dark:bg-secondary-700 ">
                  <div class="prose prose-sm appearance-none px-4 py-5 pb-8 text-xs text-text-color sm:px-6 ">
                    <div>
                      <p dir="ltr">
                        Takapedia mempersembahkan penawaran istimewa untuk para
                        gamers sejati! Kami hadir dengan layanan Top Up resmi
                        dan 100% legal untuk{" "}
                      ...
                      <p dir="ltr">
                        Top Up <strong>Mobile Legends : Bang Bang</strong>{" "}
                      ...
                      <p dir="ltr">
                        ...
                        <strong>Mobile Legends : Bang Bang </strong>(Pastikan
                        data yang Anda masukkan sudah benar dan lengkap)
                        <br />
                        2. Pilih Nominal Diamond (Kami menyediakan berbagai
                        pilihan nominal yang bisa Anda sesuaikan dengan
                        kebutuhan)
                        <br />
                        ...
                        <br />
                        4. Masukkan Kode Promo Jika Ada (Gunakan kode promo
                        untuk mendapatkan penawaran spesial dan diskon menarik)
                        <br />
                        5. Masukkan Nomor Whatsapp dan Email yang Valid
                        (Dapatkan konfirmasi dan notifikasi langsung ke kontak
                        Anda)
                        <br />
                        ...
                        rasakan sensasi permainan yang lebih seru dengan cepat
                        dan aman)
                      </p>
            ...
            <div class="col-span-3 flex flex-col space-y-8 md:col-span-2">
              <div class="rounded-xl bg-[#27242d] shadow-2xl dark:bg-secondary-700">
                <div class="flex border-b border-secondary-600">
                  <div class="flex items-center justify-center rounded-tl-xl bg-yellow-300 to-primary-200 px-4 py-2 text-xl font-semibold text-text-color-foreground text-gray-400">
                    1
                  </div>
                  <h3 class="flex w-full items-center justify-between rounded-tr-xl bg-secondary-500 px-2 py-2 text-base font-semibold leading-6 text-white bg-[#27242d] sm:px-4">
                    Masukkan Data Akun Kamu
                  </h3>
                </div>
                <div class="inputan bg-[#27242d] text-white">
                  <div>
                    <label
                      for="id"
                  ...
                  <div>
                    ...
                    <div class="flex flex-col items-start">
                      <input
                        class="relative block w-full appearance-none rounded-none border border-primary-500 bg-secondary-700 px-3 py-2 text-xs text-white placeholder-secondary-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !border-bg-color  !placeholder-black/60 accent-secondary-800 !ring-0 placeholder:text-xs focus:!bg-white focus:!ring-transparent dark:!text-secondary-800 dark:!placeholder-secondary-800"
                        type="number"
                        id="server"
                        name="server"
                        min="0"
              ...
              <div class="rounded-xl bg-[#27242d] text-white shadow-2xl dark:bg-secondary-700 mt-20">
                <div>
                  <div class="flex border-b border-secondary-600 ">
                    <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-t from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold text-gray-600 bg-yellow-300">
                      2
                    </div>
                  ...
                  <div class="flex flex-col space-y-4 p-4 sm:p-6">
                    <section>
                      ...
                      <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3">
                        <div class="bg-[#342F3C] dark:bg-secondary-600 relative flex cursor-pointer rounded-xl border border-transparent p-2.5 shadow-sm outline-none duration-300 ease-in-out hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-secondary-600 md:p-4">
                          <span class="flex flex-1">
                            <span class="flex flex-col justify-between">
                              ...
                              <div>
                                ...
                                >
                                  {formatCurrency(populer.hargapromo)}
                                </span>
                                <span
